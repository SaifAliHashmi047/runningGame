...
import {
  ...
  PRESSURE_SPAWN_INTERVAL_FLOOR_MIN,
...
export function resolveRunPressure(
  ...
  const duoSpawnChance = Math.min(0.58, duoBase + phase.duoSpawnBonus + (burstActive ? 0.15 : 0));
